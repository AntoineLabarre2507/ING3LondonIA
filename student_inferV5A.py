...
def predict(ensemble, image, preprocess, torch):
    """
    Prédiction avec poids optimaux (Précision: 84.62%)
    - ResNet-101: 0.300
    - EfficientNet-B3: 0.400
    - DenseNet-121: 0.300
    """
    ...
    # Poids optimaux pour chaque modèle
    optimal_weights = [0.600, 0.200, 0.200]  # ResNet-101, EfficientNet-B3, DenseNet-121
