...
def main():
    ...
    val_dir   = 'val'
    batch_size = 16
    epochs = 50  # AUGMENTÉ (tu peux arrêter plus tôt avec early stopping)
    lr = 1e-3
    num_workers = 2
    seed = 42
    ...
    # ============================================================
    # Boucle principale avec EARLY STOPPING
    # ============================================================
    best_acc = 0.0
    best_path = "efficientnet_b3_best.pt"
    patience_counter = 0
    patience_max = 10  # NOUVEAU : arrête si pas d'amélioration pendant 10 epochs
    start = time.time()
